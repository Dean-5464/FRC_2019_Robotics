...
*/	
	...
	DoubleSolenoid Intake_Arm = new DoubleSolenoid(5, 3);
	DoubleSolenoid Intake = new DoubleSolenoid(2, 4);
...
//		Gyro.calibrate();
	...
	public void teleopPeriodic() {
		...
		Drive.tankDrive(Arcade.getRawAxis(3)  * 0.85, Arcade.getRawAxis(1) * 0.85);
		...
		if (Arcade.getRawButton(1)) {
	Intake_Arm.set(DoubleSolenoid.Value.kForward);
		}else if (Arcade.getRawButton(4)) {
			Intake_Arm.set(DoubleSolenoid.Value.kReverse);
		}else {
		...
		//Lift Command
		if (Arcade.getRawButton(3) == true) {
			Lift_Motor.set(-0.75);
		}else if (Arcade.getRawButton(2) == true) {
			Lift_Motor.set(0.75);
		}else {
			Lift_Motor.set(0.0);
		}
...
/*	if (Arcade.getRawButton(8) && Arcade.getRawButton(8)) {
		Climb_One.set(1.0);
		Climb_Two.set(1.0);
		*/

/*		if (Arcade.getRawButton(8)) {
			Climb_One.set(-1.0);
			Climb_Two.set(-1.0);
		}else {
			Climb_One.set(0.0);
